...
$ ->
    ...
    if window.File and window.FileList and window.FileReader and window.Blob and window.Worker
        handleFileSelect1 = (evt) ->
            img_add = $(this).attr("id")=="file_add_upload" ? true : false
            _room_id = BLOCK_ID
                        ...
                        , (data) ->
                            if files.length == 1
                                ...
                                if data["exists"]
                                    ...
                                    # current_dom_file_add.attr("src",result_url)
                            ...
                            Qiniu_upload(file, upload_token, _room_id+"_f_"+md5)
        ...
        $("body").on "click",".dom_file>.sections>.section>div>.file_add",(evt)->
            dom_file_add = $(this)
