...
(function() {
  ...
  $(function() {
    var CDN_PREFIX, current_dom_img, current_dom_img_target, current_dom_img_target_rule, file_lists, handleFileSelect;
    ...
    if (window.File && window.FileList && window.FileReader && window.Blob && window.Worker) {
      handleFileSelect = function(evt) {
        ...
        img_add = (ref = $(this).attr("id") === "img_add_upload_target") != null ? ref : {
          "true": false
        };
        _room_id = BLOCK_ID;
              ...
              return $.post(worker_aim_url, {
                ...
                if (files.length === 1) {
                  ...
                  if (data["exists"]) {
                    ...
                    if (current_dom_img_target_rule === "append") {
                      current_dom_img_target.append("<img src=\"" + result_url + "\">");
                    } else if (current_dom_img_target_rule === "prepend") {
                      current_dom_img_target.prepend("<img src=\"" + result_url + "\">");
                    } else {
      ...
      return $("body").on("click", ".img_add_upload_target_now", function(evt) {
        var dom_img, dom_target, dom_target_rule, obj;
        obj = document.getElementById('img_add_upload_target');
        obj.outerHTML = obj.outerHTML;
        dom_img = $(this);
        dom_target = dom_img.attr("data-target-class");
        dom_target_rule = dom_img.attr("data-target-rule");
        if (dom_target_rule !== "replace" && dom_target_rule !== "append" && dom_target_rule !== "prepend") {
        ...
        return $("#img_add_upload_target").click();
      });
    }
  });
