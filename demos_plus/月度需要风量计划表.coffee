    ...
    <div class="wjd_plan_edit_area" style="display:none;">
        ...
        <div class="wjd_data wjd_data_col">
            <div class="wjd_data_row wjd_data_items">
                <table class="wjd_data_item" data-table="采煤工作面" border="0" cellspacing="0" cellpadding="0">
                    <tr class="tr_th">
                        <th colspan="9">采煤工作面</th>
                    </tr>
                    <tr class="tr_th">
                        <th>序号</th>
                        <th class="text_120">名称</th>
                        <th>方法</th>
                        <th>面长<br>m</th>
                        <th>采高<br>m</th>
                        <th>温度<br>℃</th>
                        <th>Qc<br>m<sup>3</sup>/min</th>
                        <th>断面<br>m<sup>2</sup></th>
                        <th>操作</th>
                    </tr>
                </table>
                <div><button class="add_tr_td" data-num="9">加一行</button></div>
            </div>
            <div class="wjd_data_row wjd_data_items">
                <table class="wjd_data_item" data-table="掘进工作面" border="0" cellspacing="0" cellpadding="0">
                    <tr class="tr_th">
                        <th colspan="11">掘进工作面</th>
                    </tr>
                    <tr class="tr_th">
                        <th>序号</th>
                        <th class="text_120">名称</th>
                        ...
                        <th>功率<br>kw</th>
                        <th>筒径<br>mm</th>
                        <th>Qj<br>m<sup>3</sup>/min</th>
                        <th>操作</th>
                    </tr>
                </table>
                <div><button class="add_tr_td" data-num="11">加一行</button></div>
            </div>
            <div class="wjd_data_row wjd_data_items">
                <table class="wjd_data_item" data-table="硐室" border="0" cellspacing="0" cellpadding="0">
                    <tr class="tr_th">
                        <th colspan="5">硐室</th>
                    </tr>
                    <tr class="tr_th">
                        <th>序号</th>
                        <th class="text_120">名称</th>
                        <th>Qd<br>m<sup>3</sup>/min</th>
                        <th>断面<br>㎡</th>
                        <th>操作</th>
                    </tr>
                </table>
                <div><button class="add_tr_td" data-num="5">加一行</button></div>
            </div>
            <div class="wjd_data_row wjd_data_items">
                <table class="wjd_data_item" data-table="其他独立供风点" border="0" cellspacing="0" cellpadding="0">
                    <tr class="tr_th">
                        <th colspan="5">其他独立供风点</th>
                    </tr>
                    <tr class="tr_th">
                        <tr class="tr_th">
                        <th>序号</th>
                        <th class="text_120">名称</th>
                        <th>Qq<br>m<sup>3</sup>/min</th>
                        <th>断面<br>m<sup>2</sup></th>
                        <th>操作</th>
                    </tr>
                </table>
...
$("body").on "click",".add_tr_td",(evt)->
    ...
    dom_table_td_num = parseInt(dom.attr("data-num"))
    td_html = ""
    for i in [0..dom_table_td_num-1]
        if i in [1]
            td_html = """
                #{td_html}
                <td contenteditable="true" class="text_120"></td>
            """
        else if i in [dom_table_td_num-1]
            td_html = """
                #{td_html}
...
root.wjd_data_load_one =(_data_comment_id,_edit=false)->
    ...
    for wjd_item in wjd_data["wjd_items"]
        ...
        for td_data in tds_data
            td_html = ""
            if _edit
                td_data_len = td_data.length-1
                if table in ["采煤工作面"]
                    td_data_len = 9-1-1
                else if table in ["掘进工作面"]
                    td_data_len = 11 -1-1
                else if table in ["硐室","其他独立供风点"]
                    td_data_len = 5-1-1
                for i in [0..td_data_len]
                    if i in [1]
                        td_html = """
                            #{td_html}
                            <td contenteditable="true" class="text_120">#{td_data[i]}</td>
                        """
                    else
                        td_html = """
                            #{td_html}
                            <td contenteditable="true">#{td_data[i]}</td>
                        """
            ...
            <td><button class="del_tr_td">删除</button></td>
                ...
                for i in [0..td_data_len]
                    if i in [1]
                        td_html = """
                            #{td_html}
                            <td contenteditable="false" class="text_120">#{td_data[i]}</td>
                        """
                    else
                        td_html = """
                            #{td_html}
                            <td contenteditable="false">#{td_data[i]}</td>
                        """
                $("table.wjd_data_item[data-table=\"#{table}\"]").append """
        <tr class="tr_td">
            #{td_html}
